        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body mt-2 pb-2">
              <form method="POST" action="../../controllers/area-parkir/store.php">
                <div class="form-group">
                  <label for="input-nama-area" class="form-control-label">Nama Area</label>
                  <input class="form-control" type="text" value="John Snow" id="input-nama-area" name="nama_area">
                </div>
                <div class="form-group">
                  <label for="input-kapasitas" class="form-control-label">Kapasitas</label>
                  <input class="form-control" type="number" id="input-kapasitas" name="kapasitas">
                </div>
                <div class="form-group">
                  <label for="input-terisi" class="form-control-label">Terisi</label>
                  <input class="form-control" type="number" id="input-terisi" name="terisi">
                </div>
                <div class="mt-4">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                </script>, <strong>Parking App</strong>
              </div>
            </div>
          </div>
        </div>
