...
<body class="g-sidenav-show  bg-gray-100">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="tabel-kendaraan">
                  <thead>
                    <tr>
                      <th class="text-start text-secondary text-xxs font-weight-bolder opacity-7">No</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Kendaraan / Pemilik</th>
  ...
  <script>
    $(document).ready(function() {
      const moduleUrl = 'kendaraan';
      const table     = $('#tabel-kendaraan').DataTable({
        processing: true,
        serverSide: true,
        searching: false,
        ajax: {
        ...
        columns: [
          ...
          },
          {
            ...
            render: function(data) {
              return `
                  <p class="text-xs mb-0">${data.warna}</p>
              `;
            }
          },
          {
            ...
            render: function(data) {
              return `
                <div class='ps-5'>
                  <a 
                      href="./${moduleUrl}/show?id=${data.id_kendaraan}"
                      class="btn btn-sm bg-gradient-warning my-auto"
                  >
                      Edit
                  </a>
                  <a 
                      href="./${moduleUrl}/delete?id=${data.id_kendaraan}"
